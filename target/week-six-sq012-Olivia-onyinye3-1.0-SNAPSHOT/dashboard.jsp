              ...
              <div class="d-flex flex-column comment-section">
                ...
                <div class="bg-light p-2">
                  ...
                  <div class="mt-2 text-right">
                    <a href="${pageContext.request.contextPath}/comment/?post_id=${post2.getPost_id()}"<button class="btn btn-primary btn-sm shadow-none" type="button">Post comment</button>
